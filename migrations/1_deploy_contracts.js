...
module.exports = async function (deployer, network, accounts) {
    ...
    // nu mai trebe, se face in constructor await controller.addParticle(part1.address);
    ...
    const part3 = await deployer.deploy(Particle, controller.address, sphere.address, [120,125], [15,20], {overwrite: true, from: "0x1246Ba0c3C25CbB3cD210Ae69f7946aC57DE56F0" });
